...
```
Clone https://github.com/hktonylee/superpowers to ~/.config/opencode/superpowers, then create directory ~/.config/opencode/plugins, then symlink ~/.config/opencode/superpowers/.opencode/plugins/superpowers.js to ~/.config/opencode/plugins/superpowers.js, then symlink ~/.config/opencode/superpowers/skills to ~/.config/opencode/skills/superpowers, then restart opencode.
```
...
if [ -d ~/.config/opencode/superpowers ]; then
  ...
  git clone https://github.com/hktonylee/superpowers.git ~/.config/opencode/superpowers
fi
...
git clone https://github.com/hktonylee/superpowers.git "%USERPROFILE%\.config\opencode\superpowers"
...
```powershell
# 1. Install Superpowers
git clone https://github.com/hktonylee/superpowers.git "$env:USERPROFILE\.config\opencode\superpowers"
...
- Report issues: https://github.com/hktonylee/superpowers/issues
- Main documentation: https://github.com/hktonylee/superpowers

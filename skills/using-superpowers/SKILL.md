...
2. **Workspace isolation next** (using-git-worktrees) - before code-changing work in a git repository, unless the user explicitly says not to use a worktree or the task is read-only

...
The headline change is **skills repository separation**: all skills, scripts, and documentation have moved from the plugin into a dedicated repository ([hktonylee/superpowers-skills](https://github.com/hktonylee/superpowers-skills)). This transforms superpowers from a monolithic plugin into a lightweight shim that manages a local clone of the skills repository. Skills auto-update on session start. Users fork and contribute improvements via standard git workflows. The skills library versions independently from the plugin.
...
**The biggest change:** Skills no longer live in the plugin. They've been moved to a separate repository at [hktonylee/superpowers-skills](https://github.com/hktonylee/superpowers-skills).
...
3. Fresh clone of hktonylee/superpowers-skills will be created at `~/.config/superpowers/skills/`
...
- Clones hktonylee/superpowers-skills on first run
...
**Removed:**
- `skills/` directory (82 files) - Now in hktonylee/superpowers-skills
- `scripts/` directory - Now in hktonylee/superpowers-skills/skills/using-skills/
...
```bash
# In Claude Code
/plugin marketplace add hktonylee/superpowers-marketplace
...
- Skills repository is now at https://github.com/hktonylee/superpowers-skills
...
**Full Changelog:** https://github.com/hktonylee/superpowers/compare/dd013f6...main
**Skills Repository:** https://github.com/hktonylee/superpowers-skills
**Issues:** https://github.com/hktonylee/superpowers/issues

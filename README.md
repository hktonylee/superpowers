...
Next up, it runs the plan inline with review checkpoints, working through each engineering task, inspecting work, and continuing forward.
...
4. **executing-plans** - Activates with plan. Executes in batches with human checkpoints.
